<template>
    <div class="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex-1 p-6 overflow-y-auto">
          <h2 class="text-3xl font-bold mb-6">Welcome Back, Ms. Jera!</h2>
  ...
  import { Menu, Bell, Search, User, Calendar, Users, CheckCircle, Circle } from 'lucide-vue-next'
  ...
  export default {
    ...
    setup() {
      ...
      const todaySessions = ref([
        { name: 'Kurt P. Reserva', subject: 'Chemistry', time: '2:00pm', isDone: false },
        { name: 'Djeah Mae Tabada', subject: 'Calculus 1', time: '2:00pm', isDone: false },
        { name: 'Grace Jean Montao', subject: 'Calculus 1', time: '2:00pm', isDone: false },
      ])
  
      const recentCourses = ref([
        { name: 'Advanced Chemistry', student: 'John Doe', date: '2023-06-15' },
        { name: 'Organic Chemistry', student: 'Jane Smith', date: '2023-06-14' },
        { name: 'Physics 101', student: 'Bob Johnson', date: '2023-06-13' },
      ])
